            ...
            <div className="flex w-max px-2">
              {tabs.map((tab: string) => (
                <div
                  ...
                  className={`px-5 py-3.5 text-[13px] font-bold whitespace-nowrap cursor-pointer transition-colors relative ${activeTab === tab ? "text-primary" : "text-gray-500 hover:text-gray-700"
                    }`}
                >
                  {tab}
                  {activeTab === tab && (

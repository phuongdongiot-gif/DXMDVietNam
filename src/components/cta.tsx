...
const CTA: React.FC = () => {
  return (
    <div className="mx-4 mt-6 mb-2 bg-gradient-to-r from-primary to-secondary rounded-xl p-5 text-white shadow-md relative overflow-hidden">
      ...
      <button className="w-full flex items-center justify-center space-x-2 bg-accent p-3 rounded-lg relative z-10 shadow-sm hover:bg-accent/90 transition-colors cursor-pointer active:scale-95">
